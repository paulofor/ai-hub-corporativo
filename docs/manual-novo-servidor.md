...
- Para payloads grandes, garanta que o MySQL esteja com `max_allowed_packet` acima do tamanho esperado (ex.: `SET GLOBAL max_allowed_packet=512*1024*1024;`) e mantenha `DB_MAX_ALLOWED_PACKET` alinhado no `.env`.
